...
public class Answer_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f13.hw4.hw4_139547.typesystems.Answer");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "edu.cmu.lti.f13.hw4.hw4_139547.typesystems.Answer");
  ...
  public int getRank(int addr) {
      ...
      jcas.throwFeatMissing("rank", "edu.cmu.lti.f13.hw4.hw4_139547.typesystems.Answer");
